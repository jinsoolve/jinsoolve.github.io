var store = [{
        "title": "Archivedata",
        "excerpt":"{ \"categories\": [\"Algorithm Theory\",\"Diary\",\"Problem Solving\",\"Kaggle\",\"ML-Lecture-cs224n\",\"공지\"], \"tags\": [\"문제-풀이-후기\",\"그리디\",\"구현\",\"완전-탐색\",\"Union-Find\",\"많은-조건-분기\",\"스택\",\"해구성하기\",\"느리게-갱신되는-세그먼트-트리\",\"이분-탐색\",\"세그먼트-트리\",\"머지소트-트리\",\"최대유량-최소비용\",\"수학\",\"큰-수-연산\",\"정렬\",\"정수론\",\"누적합\",\"다이나믹-프로그래밍\",\"펜윅-트리\",\"문자열\",\"KMP\",\"위상정렬\",\"그래프-이론\",\"사이클-검사\",\"우선순위-큐\",\"DFS\",\"트리\"], \"years\": [\"2025\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\",\"2024\"] } ","categories": [],
        "tags": [],
        ...
        "title": "백준 1462 - 퀴즈쇼",
        "excerpt":"BOJ 1462 - 퀴즈쇼 풀이 dp[i][0] := 1~i 까지 문제를 푸는데, i를 풀고 나서 남은 코인의 갯수가 0개일 때의 최댓값 dp[i][1] := 1~i 가지 문제를 푸는데, i를 풀고 나서 남은 코인의 갯수와 상관없이 최댓값 위 처럼 2가지 dp를 저장한다고 하자. 먼저 dp[i][0]를 생각해보자. i번 문제를 맞춰서 보너스 코인을 받아 코인을...","categories": ["Problem Solving"],
        "tags": ["누적합","다이나믹-프로그래밍"],
        "url": "/problem%20solving/boj-1462/",
        "teaser": null
      },{
        "title": "블로그 이전했습니다",
        "excerpt":"jinsoolve.com 으로 블로그를 이전하게 되었습니다.   앞으로는 해당 사이트에서 블로그를 운영할 예정입니다. 감사합니다.   ","categories": ["공지"],
        "tags": [],
        "url": "/%EA%B3%B5%EC%A7%80/blog-move/",
        "teaser": null
      }]
